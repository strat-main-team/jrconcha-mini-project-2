...
export default async function BlogPostPage({
  ...
  const paramsResult = await params; // https://stackoverflow.com/questions/79124951/type-error-in-next-js-route-type-params-id-string-does-not-satis
  const id = Number(paramsResult.slug.split("-")[0]);
