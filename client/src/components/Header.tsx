...
const Header: FC = () => {
  return (
    <div className="h-[60px] lg:h-[80px] px-[16px] flex items-center justify-between sticky top-0 bg-[var(--background)] md:bg-transparent md:backdrop-blur-sm border-b-1 border-b-[var(--border-color)]">
      <Link
